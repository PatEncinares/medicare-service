<main class="bg-white w-full flex flex-col items-center px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
    ...
    <section class="w-full max-w-[1500px] mx-auto rounded-2xl overflow-hidden mt-6 mb-16 relative shadow">
        <div class="relative w-full h-[650px] md:h-[400px]">
            ...
            <img 
                src="{{ asset('images/hero-images/medicare-part-d.png') }}" 
                alt="Medicare Part D"
        ...
        <div class="max-w-[1500px] mx-auto">
            <div class="py-12">
                ...
                <p class="text-base md:text-xl text-gray-700 mb-8">
                    Medicare Part D is sometimes called “hospital insurance.” In general, it covers inpatient care in hospitals, care in skilled nursing facilities, home health services, and hospice care. It can even help cover nursing home care (as long as it is not custodial or long-term care).
                </p>
